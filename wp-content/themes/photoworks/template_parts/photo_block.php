    ...
    <div class="overlay">
        <div class="icon-container">
            ...
            <a href="#" class="fullscreen-icon" 
               data-fullscreen-url="<?php echo esc_url(get_the_post_thumbnail_url(null, 'full')); ?>" 
               data-reference="<?php echo esc_html($photo_reference); ?>" 
               data-category="<?php echo esc_html(implode(', ', wp_list_pluck($photo_categorie, 'name'))); ?>"> <!-- Concatène les catégories -->
